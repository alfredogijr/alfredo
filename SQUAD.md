...
|--------|-------|----------------|
| [Product Manager](squad/agentes/01-product-manager.md) | Estratégia e Produto | Visão, roadmap, priorização, métricas |
| [Tech Lead](squad/agentes/02-tech-lead.md) | Arquitetura e Liderança Técnica | Arquitetura, decisões técnicas, code review |
| [Full-Stack Developer](squad/agentes/03-fullstack-developer.md) | Desenvolvimento Web e API | Frontend, backend, integrações |
| [Mobile Developer](squad/agentes/04-mobile-developer.md) | Desenvolvimento Mobile | iOS, Android, React Native, Flutter |
| [UX/UI Designer](squad/agentes/05-ux-ui-designer.md) | Experiência e Interface | Pesquisa, wireframes, design system |
| [QA Engineer](squad/agentes/06-qa-engineer.md) | Qualidade e Testes | Estratégia de testes, automação, bugs |

## Especialistas (Sob Demanda)

| Agente | Papel | Foco Principal |
|--------|-------|----------------|
| [DBA / Data Architect](squad/agentes/07-dba-data-architect.md) | Dados e Banco de Dados | Modelagem, performance, integridade |
| [DevOps / Cloud Engineer](squad/agentes/08-devops-cloud.md) | Infraestrutura e Deploy | CI/CD, cloud, monitoramento |

## Como Usar

### 1. Ativando um Agente

Cada arquivo em `squad/agentes/` contém um **System Prompt** pronto para uso. Para ativar um agente:
